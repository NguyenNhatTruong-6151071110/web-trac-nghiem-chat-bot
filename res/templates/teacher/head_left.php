...
<head>
	...
	<script src="https://kit.fontawesome.com/b016c51365.js" crossorigin="anonymous"></script>
	...
	<div class="sidebar-left sidebar-show menu-sidebar scrollbar" id="sidebar-left">
		...
		<ul class="collapsible reset-margin" data-collapsible="accordion">
			<li class="active">
				...
				<a href="index.php?action=show_questions_panel" class="collapsible-header font-color cursor"><i class="material-icons">list</i>Quản lý Câu Hỏi</a>
				...
				<a href="http://127.0.0.1:5000" class="collapsible-header font-color cursor" target="_blank"><i class="fa-solid fa-robot" style="margin-right: 25px"></i>ChatBot</a>
				<!-- <a href="index.php?action=show_tests_panel" class="collapsible-header font-color cursor"><i class="material-icons">send</i>Quản lý Đề Thi</a> -->
